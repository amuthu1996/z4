uninitialized constant Zammad::Application::Initializer::DBPreflightCheck::Sqlite3 (NameError)sudo sysctl fs.inotify.max_user_watches=524288
$ sudo sysctl -p# Welcome to Zammad
